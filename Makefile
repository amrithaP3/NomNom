...
# OFILES = gba.o font.o main.o images/garbage.o images/start.o images/game.o images/win.o images/lose.o images/pizza.o images/broccoli.o images/donut.o images/ramen.o images/castle.o images/smile.o images/smile2.o images/background.o
